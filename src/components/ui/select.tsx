...
>(({ className, children, ...props }, ref) => (
  <span className={cn(styles.selectWrapper, "relative block")}>
    <select
      ref={ref}
      className={cn(
        styles.select,
    ...
    <ChevronDown
      className={cn(styles.selectIcon, "pointer-events-none absolute top-1/2 right-3 size-4 -translate-y-1/2 text-slate-500")}
      aria-hidden="true"
    />
  </span>
));
